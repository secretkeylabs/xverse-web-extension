    ...
    async (isEffectActive) => {
      try {
        ...
        if (fungibleToken) {
          ...
          const rawUnsignedSendFtTx = await generateUnsignedTokenTransferTransaction({
        ...
        console.log(debouncedRecipient, debouncedAmount);
        ...
        console.log('🚀 ~ rawUnsignedSendStxTx:', rawUnsignedSendStxTx);
